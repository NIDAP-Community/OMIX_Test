...
| Image | Pull | Docs |
| --- | --- | --- |
| `omix-r-base` | `docker pull ghcr.io/nidap-community/omix-r-base:latest` | [README](starter-environments/r-base/README.md) |
| `omix-r-visualization` | `docker pull ghcr.io/nidap-community/omix-r-visualization:latest` | [README](starter-environments/r-visualization/README.md) |
| `omix-r-pathway` | `docker pull ghcr.io/nidap-community/omix-r-pathway:latest` | [README](starter-environments/r-pathway/README.md) |

For Singularity/Apptainer on HPC:

```bash
singularity pull omix-r-pathway.sif docker://ghcr.io/nidap-community/omix-r-pathway:latest
```

See each image's README for full usage examples, CLI options, and Slurm templates.
